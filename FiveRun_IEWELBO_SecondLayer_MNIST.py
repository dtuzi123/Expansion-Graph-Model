...
parser.add_argument("--stochastic_layers", type=int, default=2, choices=[1, 2],
...
parser.add_argument("--gpu", type=str, default='7', help="Choose GPU")
...
for runIndex in range(RunCount):
    ...
    resultsArr.append(test_set_llh)
