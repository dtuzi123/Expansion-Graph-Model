...
f = open("results/IELBO_TwoModels_VAE" + str(0) + ".txt", "w", encoding="utf-8")
...
f = open("results/IELBO_TwoModels_IWVAE1" + str(0) + ".txt", "w", encoding="utf-8")
for i in range(np.shape(lossArr1)[0]):
    f.writelines(lossArr1[i])
    f.writelines('\n')
f.flush()
...
f = open("results/IELBO_TwoModels_IWVAE2" + str(0) + ".txt", "w", encoding="utf-8")
for i in range(np.shape(lossArr1)[0]):
    f.writelines(lossArr1[i])
    f.writelines('\n')
f.flush()
